...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const updateSidebarClock = () => {
      ...
      if (clockStatus) clockStatus.textContent = hours + ':' + minutes;
    };
    
    updateSidebarClock();
    const clockInterval = setInterval(updateSidebarClock, 1000);
      ...
      <script dangerouslySetInnerHTML={{
        __html: `
          ...
          window.showToast = function(message) {
            ...
            if (toast) {
              toast.textContent = message || 'Notifikasi';
